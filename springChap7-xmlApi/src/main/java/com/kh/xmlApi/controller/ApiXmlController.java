...
public class ApiXmlController {
	...
	public ResponseEntity<?> xmlApi() {
		...
		// 파일 자체를 다운받아서 가지고 있다면 1. apiUrl 2. Key
		// 값을 넣어줄 의무가 없다.
		...
		// 추후에 return 데이터 목록
  		...
  		// 위 mapList에서 받아오는  형식과 = 을 써서 가져오는 형식이 같아야한다.
new ArrayList<Map<String, Object>>();
		...
		try {
			...
			//***** split() : 입력 받은 형식을 정규 표현식이나 특정 문자를 기준으로
			// 문자열을 나누어 배열에 저장해서 리턴
